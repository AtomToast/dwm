...
static const char col_urgborder[] = "#e73c50";
static const char *colors[][3] = {
    ...
    [SchemeUrg] = {col_gray3, col_green, col_urgborder},
};
...
static const char *dmenucmd[] = {
    ...
    "-nf",       col_cyan, "-sb",    col_green, "-sf",     col_gray3, NULL};
static const char *termcmd[] = {"st", NULL};

/*First arg only serves to match against key in rules*/
static const char *scratchpadcmd[] = {"s",  "st",     "-t", "scratchpad",
                                      "-g", "239x30", NULL};
static const char *qalcpadcmd[] = {"q",      "st", "-t",   "qalcpad", "-g",
                                   "239x30", "-e", "qalc", NULL};
